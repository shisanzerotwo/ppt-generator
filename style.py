...
_BODY_FONT = '"Microsoft YaHei", "PingFang SC", sans-serif'

# 每风格一组标题字体：正文统一用 _BODY_FONT 保证可读，标题靠字体族做差异化
# （全部为 Windows 常见中文字体 + mac/网页后备，机器没有时优雅降级不缺字）
STYLE_LIBRARY = {
    "tech-deep": {
        "name": "深空科技",
        ...
        "font_title": '"SimHei", "Microsoft YaHei", "PingFang SC", sans-serif',
        "font_body": _BODY_FONT,
    },
    "business-minimal": {
        "name": "极简商务",
        ...
        "font_title": '"DengXian", "Microsoft YaHei", "PingFang SC", sans-serif',
        "font_body": _BODY_FONT,
    },
    "fresh-light": {
        "name": "清新浅色",
        ...
        "font_title": '"YouYuan", "Microsoft YaHei", "PingFang SC", sans-serif',
        "font_body": _BODY_FONT,
    },
    "warm-editorial": {
        "name": "暖调人文",
        ...
        "font_title": '"STZhongsong", "SimSun", "Songti SC", serif',
        "font_body": _BODY_FONT,
    },
    "vivid-gradient": {
        "name": "活力渐变",
        ...
        "font_title": '"Impact", "SimHei", "Microsoft YaHei", "PingFang SC", sans-serif',
        "font_body": _BODY_FONT,
    },
    "nature-green": {
        "name": "自然墨绿",
        ...
        "font_title": '"KaiTi", "STKaiti", "Kaiti SC", serif',
        "font_body": _BODY_FONT,
    },
}
...
def style_guidance(style: dict) -> str:
    ...
    if not style:
        return ""
    t_font = style.get("font_title") or '"Microsoft YaHei", sans-serif'
    b_font = style.get("font_body") or '"Microsoft YaHei", sans-serif'
    return (
