...
2. 视觉规范（必须遵守）：每页只讲一个观点；要点 3~4 条、每条不超过 20 字；不堆砌文字
3. 每页输出 title（页标题）、points（要点列表）、image_prompt（与该页内容匹配的中文画面描述，用于 AI 生图，描述具体场景、风格统一为扁平插画风格）
4. 封面页 points 为空列表，image_prompt 描述一张体现主题的封面插图
